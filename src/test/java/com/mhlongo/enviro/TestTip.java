...
public class TestTip {
    ...
    public static String CONTENT = " Before placing plastic containers in your recycling bin, make sure to rinse them thoroughly and let them dry. This simple step helps in several ways:\r\n" + //
                ...
                "    2. Reduces odors and pests: Clean containers don't attract pests or create unpleasant odors in recycling facilities.\r\n" + //
                "    3. Improves recycling efficiency: Clean materials are easier and more efficient to process.\r\n" + //
                "    4. Ensures worker safety: Clean materials create a more hygienic environment for recycling facility workers.\r\n" + //
                "\r\n" + //
                "    Remember, you don't need to use hot water or soap - a quick rinse with cold water is usually sufficient. After rinsing, shake out excess water and let the container air dry before placing it in your recycling bin.\r\n";
